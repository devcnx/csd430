<%-- 
    Movie Display Page - Module 08 Assignment
    Student: Brittaney Perry-Morgan
    This page displays the updated movie record in a table format
--%>
...
<body>
    ...
    <h2>CSD430 - Module 08 Assignment</h2>
    
    <div class="form-container">
        <p class="description">
            This page displays the updated movie record in a table format.
            The data is retrieved from the database and displayed with field headers.
        </p>
...
%>
        ...
        <a href="movie_update.jsp" class="btn">Update Another Movie</a>
        <a href="index.jsp" class="btn btn-secondary">Course Index</a>
    </div>
