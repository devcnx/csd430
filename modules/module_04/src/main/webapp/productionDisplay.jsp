...
<%--
    ...
    Description: Displays only the Production Information from the MovieBean JavaBean.
    All Java code is within Scriptlets. All HTML tags are outside of
    Scriptlets. External CSS is used for styling.

    productionDisplay.jsp - Production Information Display Page
--%>
...
<html lang="en">
<head>
    <title>Module 4 Assignment: JavaBean - Production Information</title>
...
<body>
    <div class="container top-title">
        ...
        <p class="description">This page displays the production information for the movie, retrieved from the MovieBean JavaBean.</p>
    </div>
