<%-- 
    Movie Selection Page - Module 05 & 06 Assignment
    Student: Brittaney Perry-Morgan
    This page displays a dropdown menu with all movie IDs from the database
--%>
...
<body>
    <h1>Movie Database Selection</h1>
    
    <div class="form-container">
        <p class="info">Select a movie ID from the dropdown menu to view its details.</p>
...
%>
            ...
            <button type="submit">View Movie Details</button>
        </form>
<%
                }
            }
